...
void main() {
  ...
  group('ChangeEmpowerCommand', () {
    ...
    test('should add an empowerment to a monster instance', () {
      ...
      final initialEmpowerCount = getIt<GameState>().modifierDeck
          .getRemovable("in-empower")
          .value;
      ...
      // Assert
      final finalEmpowerCount = getIt<GameState>().modifierDeck
          .getRemovable("in-empower")
          .value;
      expect(finalEmpowerCount, initialEmpowerCount + 1);
      checkSaveState();
    ...
    test('ally monster owner uses modifierDeckAllies', () {
      ...
      final alliesDeckBefore = gs.modifierDeckAllies
          .getRemovable("in-empower")
          .value;
      ChangeEmpowerCommand(
        1,
