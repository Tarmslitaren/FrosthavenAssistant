...
void main() {
  ...
  group('AMDRevealCommand', () {
    test('should set revealedCount on the main modifier deck', () {
      final command = AMDRevealCommand(
          amount: 2, name: 'Monsters', gameState: getIt<GameState>());
      command.execute();
    ...
    test('should set revealedCount to zero when amount is 0', () {
      AMDRevealCommand(
              amount: 3, name: 'Monsters', gameState: getIt<GameState>())
          .execute();
      AMDRevealCommand(
              amount: 0, name: 'Monsters', gameState: getIt<GameState>())
          .execute();
