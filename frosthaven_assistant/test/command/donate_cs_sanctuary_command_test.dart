...
void main() {
  ...
  group('DonateCSSanctuaryCommand', () {
    test('should add sanctuary cards to character modifier deck', () {
      ...
      DonateCSSanctuaryCommand(character.id, gameState: getIt<GameState>()).execute();
    ...
    test('describe includes character id', () {
      final command = DonateCSSanctuaryCommand(character.id, gameState: getIt<GameState>());
  ...
  group('RemoveCSSanctuaryDonationCommand', () {
    test('should remove sanctuary cards from character modifier deck', () {
      ...
      RemoveCSSanctuaryDonationCommand(character.id, gameState: getIt<GameState>()).execute();
    ...
    test('describe includes character id', () {
      final command = RemoveCSSanctuaryDonationCommand(character.id, gameState: getIt<GameState>());
