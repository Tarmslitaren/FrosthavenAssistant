...
import 'package:frosthaven_assistant/Layout/menus/gh2e_faction_amd_card_menu.dart'
    show GH2eFactionAMDCardMenu;
...
void main() {
  ...
  group('Gh2eFactionAmdCardMenu', () {
    ...
    testWidgets('tapping a faction card adds it to deck', (
      WidgetTester tester,
    ) async {
      await pumpMenu(tester);
    ...
    testWidgets('tapping remove button removes the faction card', (
      WidgetTester tester,
    ) async {
      await pumpMenu(tester);
      // Find InkWells inside GH2eFactionAMDCardMenu (not the ElevatedButton)
