...
class FigureState {
  ...
  setHealth(_StateModifier stateModifier, int value) {
    _health.value = value;
  }

  ValueListenable<int> get level => _level;
  final _level = ValueNotifier<int>(1);
  setFigureLevel(_StateModifier stateModifier, int value) {
    _level.value = value;
  }

  ValueListenable<int> get maxHealth => _maxHealth;
  final _maxHealth = ValueNotifier<int>(0);
  setMaxHealth(_StateModifier stateModifier, int value) {
  ...
  setChill(_StateModifier stateModifier, int value) {
    _chill.value = value;
  }
  ...
  Set<Condition> getMutableConditionsAddedThisTurn(
  ...
  Set<Condition> getMutableConditionsAddedPreviousTurn(
      _StateModifier stateModifier) {
