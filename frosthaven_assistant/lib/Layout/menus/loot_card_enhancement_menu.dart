...
class LootCardEnhancementMenuState extends State<LootCardEnhancementMenu> {
  ...
  Widget createListTile(name, int startIndex, int amount, List<bool> reference,
      String materialName) {
            ...
            children: [
                ...
                onChanged: (bool? newValue) {
                  setState(() {
                    getIt<GameState>().action(EnhanceLootCardCommand(
                        newValue!, startIndex, materialName));
                  });
                },
              ...
              Checkbox(
                ...
                onChanged: (bool? newValue) {
                  setState(() {
                    getIt<GameState>().action(EnhanceLootCardCommand(
                        newValue!, startIndex + 1, materialName));
                  });
                },
              ),
              if (amount == 3)
                Checkbox(
                  ...
                  onChanged: (bool? newValue) {
                    setState(() {
                      getIt<GameState>().action(EnhanceLootCardCommand(
                          newValue!, startIndex + 2, materialName));
                    });
                  },
                )
            ],
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              createListTile(
                                  ...
                                  0,
                                  2,
                                  _gameState.lootDeck.lumberEnhancements,
                                  "lumber"),
                              createListTile(
                                  "lumber 2 for 2p ",
                                  2,
                              ...
                              createListTile(
                                  ...
                                  0,
                                  2,
                                  _gameState.lootDeck.metalEnhancements,
                                  "metal"),
                              createListTile(
                                  "metal 2 for 2p",
                                  2,
                              ...
                              createListTile(
                                  ...
                                  0,
                                  2,
                                  _gameState.lootDeck.arrowvineEnhancements,
                                  "arrowvine"),
                              createListTile(
                                  "axenut",
                                  0,
                                  2,
                                  _gameState.lootDeck.axenutEnhancements,
                                  "axenut"),
                              createListTile(
                                  "corpsecap",
                                  0,
                                  2,
                                  _gameState.lootDeck.corpsecapEnhancements,
                                  "corpsecap"),
                              createListTile(
                                  "flamefruit",
                                  0,
                                  2,
                                  _gameState.lootDeck.flamefruitEnhancements,
                                  "flamefruit"),
                              createListTile(
                                  "rockroot",
                                  0,
                                  2,
                                  _gameState.lootDeck.rockrootEnhancements,
                                  "rockroot"),
                              createListTile(
                                  "snowthistle",
                                  0,
                                  2,
                                  _gameState.lootDeck.snowthistleEnhancements,
                                  "snowthistle"),
                            ]),
                      ),
                      const SizedBox(
