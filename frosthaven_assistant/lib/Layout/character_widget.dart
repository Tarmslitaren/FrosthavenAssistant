...
class _CharacterWidgetState extends State<CharacterWidget> {
  ...
  void initState() {
    ...
    for (var character in _gameState.currentList) {
      if(character is Character && character.characterClass.name == widget.characterClass.name) {
                ...
                child: Row(
                  children: [
                    Image(
                      ...
                      image: AssetImage("assets/images/class-icons/${widget.characterClass.name}.png",),
                      //width: widget.height*0.8,
                    ),

                    _characterState.initiative.value == 0
                        ? const SizedBox()
                        : Column(children: [
                            Image(
                              //fit: BoxFit.contain,
                            ...
                            Text(
                              _characterState.initiative.value.toString(),
